...
*** TODO [#B] Add storage for favorite keywords
*** TODO [#B] Add shortcut key for favorite keywords
...
** TODO [#D] Need to be able to delete keywording buttons
** TODO [#B] Add key shortcuts for keywording buttons
