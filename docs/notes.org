...
*** TODO [#B] Make keyword browsing default to best image.
*** TODO [#B] Store best image in :sample if it is empty
*** TODO [#B] editing functions
**** TODO [#C] add-keyword
**** TODO [#C] safe-delete-keyword
**** TODO [#C] rename-keyword
**** TODO [#C] disconnect-keyword
**** TODO [#C] move-keyword
**** TODO [#C] merge-keyword
*** TODO [#D] Handle orphaned and empty keywords
*** TODO [#E] sample stores a path with .jpg on the end. Remove it.
