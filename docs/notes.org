...
[2019-05-28] Removed grunt and electron-download altogether now. Install electron with:
#+BEGIN_SRC shell
...
[2024-02-16] Use this:
#+begin_src shell
npx @electron/packager app/prod --icon=resources/anh.icns --overwrite
#+end_src
** Electron Update
...
** Archive                                                          :ARCHIVE:
*** DONE [#A] Documentation is out of date
CLOSED: [2023-03-01 Wed 21:49]
:PROPERTIES:
:ARCHIVE_TIME: 2023-03-01 Wed 21:50
:END:
