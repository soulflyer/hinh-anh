...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__13458 = cljs.core.instance_QMARK_;
var expr__13459 = reactive_val;
if(cljs.core.truth_(pred__13458.call(null,mranderson047.reagent.v0v7v0.reagent.ratom.RAtom,expr__13459))){
return "ra";
} else {
if(cljs.core.truth_(pred__13458.call(null,mranderson047.reagent.v0v7v0.reagent.ratom.RCursor,expr__13459))){
return "rc";
} else {
if(cljs.core.truth_(pred__13458.call(null,mranderson047.reagent.v0v7v0.reagent.ratom.Reaction,expr__13459))){
return "rx";
} else {
if(cljs.core.truth_(pred__13458.call(null,mranderson047.reagent.v0v7v0.reagent.ratom.Track,expr__13459))){
return "tr";
} else {
return "other";
}
