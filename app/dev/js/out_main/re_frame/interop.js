...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__15998 = cljs.core.instance_QMARK_;
var expr__15999 = reactive_val;
if(cljs.core.truth_(pred__15998.call(null,reagent.ratom.RAtom,expr__15999))){
return "ra";
} else {
if(cljs.core.truth_(pred__15998.call(null,reagent.ratom.RCursor,expr__15999))){
return "rc";
} else {
if(cljs.core.truth_(pred__15998.call(null,reagent.ratom.Reaction,expr__15999))){
return "rx";
} else {
if(cljs.core.truth_(pred__15998.call(null,reagent.ratom.Track,expr__15999))){
return "tr";
} else {
return "other";
}
