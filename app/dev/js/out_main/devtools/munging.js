...
var o16161 = temp__4655__auto__;
var temp__4655__auto____$1 = (o16161["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o16162 = temp__4655__auto____$1;
return (o16162["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__16019__auto__ = f;
return (o__16019__auto__["toString"]).call(o__16019__auto__);
} else {
return "";
}
}catch (e16163){var _ = e16163;
return "";
}});
...
try{var o__16019__auto___16165 = t;
(o__16019__auto___16165["cljs$lang$ctorPrWriter"]).call(o__16019__auto___16165,t,writer);
}catch (e16164){var __16166 = e16164;
}
...
var char_code = (function (){var o__16019__auto__ = (new String(char$));
return (o__16019__auto__["charCodeAt"]).call(o__16019__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__16019__auto__ = String;
return (o__16019__auto__["fromCharCode"]).call(o__16019__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__16167 = num_code;
switch (G__16167) {
case (1):
return (185);
...
var o__16019__auto__ = String;
return (o__16019__auto__["fromCharCode"]).call(o__16019__auto__,superscript_code);
});
/**
...
}catch (e16169){var _e__16026__auto__ = e16169;
return false;
}})())){
...
var vec__16170 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__16170,(0),null);
...
var or__7895__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
if(cljs.core.truth_(temp__4655__auto__)){
var o16173 = temp__4655__auto__;
var temp__4655__auto____$1 = (o16173["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o16174 = temp__4655__auto____$1;
return (o16174["nameToPath"]);
} else {
return null;
}
} else {
...
var len__9057__auto___16181 = arguments.length;
var i__9058__auto___16182 = (0);
while(true){
if((i__9058__auto___16182 < len__9057__auto___16181)){
args__9064__auto__.push((arguments[i__9058__auto___16182]));

var G__16183 = (i__9058__auto___16182 + (1));
i__9058__auto___16182 = G__16183;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__9065__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__16177){
var vec__16178 = p__16177;
var ns_detector = cljs.core.nth.call(null,vec__16178,(0),null);
var effective_detector = (function (){var or__7895__auto__ = ns_detector;
if(cljs.core.truth_(or__7895__auto__)){
return or__7895__auto__;
} else {
...
var G__16184 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__16185 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__16184;
remaining_tokens = G__16185;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq16175){
var G__16176 = cljs.core.first.call(null,seq16175);
var seq16175__$1 = cljs.core.next.call(null,seq16175);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__16176,seq16175__$1);
});
...
var vec__16189 = cljs.core.split_with.call(null,(function (p1__16188_SHARP_){
return cljs.core.not_EQ_.call(null,p1__16188_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__16189,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__16189,(1),null);
...
var vec__16192 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__16192,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__16192,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__16195 = cljs.core.rest.call(null,remaining_tokens);
var G__16196 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__16195;
name_tokens = G__16196;
continue;
} else {
...
var vec__16199 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__16199,(0),null);
var arity = cljs.core.nth.call(null,vec__16199,(1),null);
var vec__16202 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__16202,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__16202,(1),null);
var vec__16205 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__16205,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__16205,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__16205,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__16205,(3),null);
...
var vec__16211 = result;
var munged_ns = cljs.core.nth.call(null,vec__16211,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__16211,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__16211,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__16211,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__16211,(4),null);
var arity = cljs.core.nth.call(null,vec__16211,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__16215 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__16215,(0),null);
var args = cljs.core.nth.call(null,vec__16215,(1),null);
var vec__16218 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__16218,(0),null);
var name = cljs.core.nth.call(null,vec__16218,(1),null);
...
var G__16221 = (arity + (1));
var G__16222 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__16223){
var vec__16224 = p__16223;
var arity = cljs.core.nth.call(null,vec__16224,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__16224,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__7895__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__7895__auto__)){
return or__7895__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__16227_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__16228_SHARP_);
...
var args__9064__auto__ = [];
var len__9057__auto___16235 = arguments.length;
var i__9058__auto___16236 = (0);
while(true){
if((i__9058__auto___16236 < len__9057__auto___16235)){
args__9064__auto__.push((arguments[i__9058__auto___16236]));

var G__16237 = (i__9058__auto___16236 + (1));
i__9058__auto___16236 = G__16237;
continue;
} else {
}
break;
...
var argseq__9065__auto__ = ((((1) < args__9064__auto__.length))?(new cljs.core.IndexedSeq(args__9064__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__9065__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__16231){
var vec__16232 = p__16231;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__16232,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq16229){
var G__16230 = cljs.core.first.call(null,seq16229);
var seq16229__$1 = cljs.core.next.call(null,seq16229);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__16230,seq16229__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__7895__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__7895__auto__)){
return or__7895__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__7883__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__7895__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__7895__auto__)){
return or__7895__auto__;
} else {
...
var map__16240 = options;
var map__16240__$1 = ((((!((map__16240 == null)))?((((map__16240.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__16240.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__16240):map__16240);
var include_ns_QMARK_ = cljs.core.get.call(null,map__16240__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__16240__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__16240__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__16240__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__16241 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__16241,(0),null);
var fn_name = cljs.core.nth.call(null,vec__16241,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__16241,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__16241,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__16241,(4),null);
var arity = cljs.core.nth.call(null,vec__16241,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__7883__auto__ = protocol_ns;
if(cljs.core.truth_(and__7883__auto__)){
return cljs.core.not.call(null,(function (){var and__7883__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__7895__auto__ = protocol_part;
if(cljs.core.truth_(or__7895__auto__)){
return or__7895__auto__;
} else {
return fn_part;
...
var o__16019__auto__ = f;
return (o__16019__auto__["getBasis"]).call(o__16019__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__7883__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__7883__auto__)){
...
}catch (e16245){var _e__16026__auto__ = e16245;
...
var G__16246 = (obj[cljs.core.first.call(null,path)]);
var G__16247 = cljs.core.rest.call(null,path);
obj = G__16246;
path = G__16247;
continue;
} else {
...
var partition_bits = (function (){var or__7895__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__7895__auto__)){
return or__7895__auto__;
} else {
return (0);
...
return (function (accum,p__16248){
var vec__16249 = p__16248;
var bit = cljs.core.nth.call(null,vec__16249,(0),null);
var protocol = cljs.core.nth.call(null,vec__16249,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__16252){
var vec__16253 = p__16252;
var ns = cljs.core.nth.call(null,vec__16253,(0),null);
var name = cljs.core.nth.call(null,vec__16253,(1),null);
var selector = cljs.core.nth.call(null,vec__16253,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__16258,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__16258,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__16258,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__16256_SHARP_){
return (obj[cljs.core.first.call(null,p1__16256_SHARP_)]);
});})(name,sorted_matches,vec__16258,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
