...
var len__9057__auto___16292 = arguments.length;
var i__9058__auto___16293 = (0);
while(true){
if((i__9058__auto___16293 < len__9057__auto___16292)){
args__9064__auto__.push((arguments[i__9058__auto___16293]));

var G__16294 = (i__9058__auto___16293 + (1));
i__9058__auto___16293 = G__16294;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__9065__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq16289){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__16290,G__16291,seq16289__$2);
});
...
if(cljs.core.truth_((function (){var or__7895__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__8520__auto__,writer__8521__auto__,opt__8522__auto__){
return cljs.core._write.call(null,writer__8521__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__7883__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__7883__auto__){
var or__7895__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__7895__auto__)){
return or__7895__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__16295_SHARP_){
return !((cljs.core.meta.call(null,p1__16295_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__16296__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__7895__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e16300){var _e__16026__auto__ = e16300;
return false;
}})();
if(cljs.core.truth_(or__7895__auto__)){
return or__7895__auto__;
...
}catch (e16302){var _e__16026__auto__ = e16302;
return false;
}}
})())){
...
var _STAR_current_state_STAR_16304 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__16305 = opts;
...
var markup_db = cljs.core.get.call(null,map__16305__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_16304;
}});
...
;
var temp__4655__auto___16309 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___16309)){
var managed_print_level_16310 = temp__4655__auto___16309;
var _STAR_print_level_STAR_16308_16311 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_16310;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_16308_16311,managed_print_level_16310,temp__4655__auto___16309,writer,opts,job_fn){
return (function (p1__16307_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__16307_SHARP_,null);
});})(_STAR_print_level_STAR_16308_16311,managed_print_level_16310,temp__4655__auto___16309,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_16308_16311;
}} else {
job_fn.call(null);
}
