...
var G__16263 = devtools.prefs.pref.call(null,v);
v = G__16263;
continue;
} else {
return v;
...
var and__7883__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__7883__auto__){
var and__7883__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__7895__auto__ = (function (){try{if(!((value == null))){
...
}catch (e16266){var _e__16026__auto__ = e16266;
return false;
}})();
if(cljs.core.truth_(or__7895__auto__)){
return or__7895__auto__;
} else {
var or__7895__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e16270){var _e__16026__auto__ = e16270;
return false;
}})();
...
}catch (e16272){var _e__16026__auto__ = e16272;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__7883__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__7883__auto__)){
var and__7883__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__7883__auto____$1){
...
var and__7883__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__7883__auto__)){
...
var or__7895__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__7895__auto__)){
return or__7895__auto__;
} else {
...
var and__7883__auto__ = (function (){var or__7895__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__7895__auto__)){
return or__7895__auto__;
} else {
...
var vec__16274 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__16274,(0),null);
var name = cljs.core.nth.call(null,vec__16274,(1),null);
...
var and__7883__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__7883__auto__)){
...
var or__7895__auto__ = typeof value === 'string';
if(or__7895__auto__){
return or__7895__auto__;
} else {
var or__7895__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__16277_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__16277_SHARP_);
}),template);
});
