...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__8520__auto__,writer__8521__auto__,opt__8522__auto__){
return cljs.core._write.call(null,writer__8521__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__15852 = o;
(G__15852[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__15853__delegate = function (args){
...
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__15857_SHARP_);
...
var vec__15861 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__15861,(0),null);
var id = cljs.core.nth.call(null,vec__15861,(1),null);
var class$ = cljs.core.nth.call(null,vec__15861,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___15865 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___15865 == null)){
} else {
var key_15866 = temp__4661__auto___15865;
...
var G__15867 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__15867["name"] = c);
...
var len__9057__auto___15871 = arguments.length;
var i__9058__auto___15872 = (0);
while(true){
if((i__9058__auto___15872 < len__9057__auto___15871)){
args__9064__auto__.push((arguments[i__9058__auto___15872]));

var G__15873 = (i__9058__auto___15872 + (1));
i__9058__auto___15872 = G__15873;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__9065__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq15869){
var G__15870 = cljs.core.first.call(null,seq15869);
var seq15869__$1 = cljs.core.next.call(null,seq15869);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__15870,seq15869__$1);
});
...
break;
default:
var G__15876 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__15876;
continue;
...
var n__8839__auto___15878 = a.length;
var i_15879 = (0);
while(true){
if((i_15879 < n__8839__auto___15878)){
(a[i_15879] = reagent.impl.template.as_element.call(null,(a[i_15879])));
...
var a = cljs.core.into_array.call(null,s);
var n__8839__auto___15881 = a.length;
var i_15882 = (0);
while(true){
if((i_15882 < n__8839__auto___15881)){
var val_15883 = (a[i_15882]);
if((cljs.core.vector_QMARK_.call(null,val_15883)) && ((reagent.impl.template.key_from_vec.call(null,val_15883) == null))){
(o["no-key"] = true);
} else {
}

(a[i_15882] = reagent.impl.template.as_element.call(null,val_15883));
...
var ctx = ({});
var vec__15885 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__15885,(0),null);
var derefed = cljs.core.nth.call(null,vec__15885,(1),null);
...
var G__15888 = (cljs.core.count.call(null,argv) - first_child);
switch (G__15888) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__15888){
