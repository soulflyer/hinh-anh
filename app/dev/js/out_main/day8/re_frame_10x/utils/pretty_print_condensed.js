...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.subs.call(null,string,(0),(function (){var G__14551 = per_side_budget;
...
var G__14558 = clojure.string.replace.call(null,s,match,trunc_prefix);
var G__14559 = limit;
var G__14560 = match;
var G__14561 = trunc_prefix;
s = G__14558;
limit = G__14559;
match = G__14560;
trunc_prefix = G__14561;
continue;
}
}
break;
...
var prefix = (function (){var G__14562 = ((kw_QMARK_)?":":"");
if(cljs.core.truth_(the_ns)){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14562),"\u2026/"].join('');
} else {
return G__14562;
}
})();
...
var vec__14564 = day8.re_frame_10x.utils.pretty_print_condensed.edges.call(null,coll);
var left = cljs.core.nth.call(null,vec__14564,(0),null);
var right = cljs.core.nth.call(null,vec__14564,(1),null);
...
var or__7895__auto__ = (function (){var G__14571 = form.name;
if((G__14571 == null)){
return null;
} else {
return clojure.string.replace.call(null,G__14571,/(^.*\$)(.*)/,"$2");
}
})();
...
if(cljs.core.truth_((function (){var and__7883__auto__ = enter_pred.call(null,form);
