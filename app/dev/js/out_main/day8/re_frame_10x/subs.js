...
return cljs.core.map.call(null,(function (p1__19149_SHARP_){
return cljs.core.assoc.call(null,cljs.core.val.call(null,p1__19149_SHARP_),new cljs.core.Keyword(null,"id","id",-1388402092),cljs.core.key.call(null,p1__19149_SHARP_));
...
mranderson047.re_frame.v0v10v2.re_frame.core.reg_sub.call(null,new cljs.core.Keyword("traces","current-event-traces","traces/current-event-traces",1386605769),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("traces","all-traces","traces/all-traces",-755374523)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","beginning-trace-id","epochs/beginning-trace-id",-1340593887)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","ending-trace-id","epochs/ending-trace-id",-1920901579)], null),(function (p__19154,_){
var vec__19155 = p__19154;
var traces = cljs.core.nth.call(null,vec__19155,(0),null);
var beginning = cljs.core.nth.call(null,vec__19155,(1),null);
var ending = cljs.core.nth.call(null,vec__19155,(2),null);
...
day8.re_frame_10x.subs.filter_ignored_views = (function day8$re_frame_10x$subs$filter_ignored_views(p__19158,_){
var vec__19159 = p__19158;
var traces = cljs.core.nth.call(null,vec__19159,(0),null);
var filtered_views = cljs.core.nth.call(null,vec__19159,(1),null);
...
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.remove.call(null,((function (munged_ns,vec__19159,traces,filtered_views){
return (function (trace){
var and__7883__auto__ = day8.re_frame_10x.metamorphic.render_QMARK_.call(null,trace);
...
});})(munged_ns,vec__19159,traces,filtered_views))
),traces);
});
...
mranderson047.re_frame.v0v10v2.re_frame.core.reg_sub.call(null,new cljs.core.Keyword("epochs","current-match-state","epochs/current-match-state",-1577612281),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","epoch-root","epochs/epoch-root",-2097634597)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","match-ids","epochs/match-ids",-669448057)], null),(function (p__19162,_){
var vec__19163 = p__19162;
var epochs = cljs.core.nth.call(null,vec__19163,(0),null);
var match_ids = cljs.core.nth.call(null,vec__19163,(1),null);
...
mranderson047.re_frame.v0v10v2.re_frame.core.reg_sub.call(null,new cljs.core.Keyword("epochs","older-epochs-available?","epochs/older-epochs-available?",366051335),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","current-epoch-id","epochs/current-epoch-id",-482598682)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","match-ids","epochs/match-ids",-669448057)], null),(function (p__19166){
var vec__19167 = p__19166;
var current = cljs.core.nth.call(null,vec__19167,(0),null);
var ids = cljs.core.nth.call(null,vec__19167,(1),null);
return (((1) < cljs.core.count.call(null,ids))) && (((current == null)) || ((current > cljs.core.nth.call(null,ids,(0)))));
}));
mranderson047.re_frame.v0v10v2.re_frame.core.reg_sub.call(null,new cljs.core.Keyword("epochs","newer-epochs-available?","epochs/newer-epochs-available?",-1411103953),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","current-epoch-id","epochs/current-epoch-id",-482598682)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","match-ids","epochs/match-ids",-669448057)], null),(function (p__19170){
var vec__19171 = p__19170;
var current = cljs.core.nth.call(null,vec__19171,(0),null);
var ids = cljs.core.nth.call(null,vec__19171,(1),null);
...
return cljs.core.filter.call(null,(function (p1__19174_SHARP_){
var or__7895__auto__ = day8.re_frame_10x.metamorphic.request_animation_frame_QMARK_.call(null,p1__19174_SHARP_);
if(cljs.core.truth_(or__7895__auto__)){
return or__7895__auto__;
} else {
return day8.re_frame_10x.metamorphic.request_animation_frame_end_QMARK_.call(null,p1__19174_SHARP_);
}
}),traces);
}));
...
var len__9057__auto___19181 = arguments.length;
var i__9058__auto___19182 = (0);
while(true){
if((i__9058__auto___19182 < len__9057__auto___19181)){
args_arr__9076__auto__.push((arguments[i__9058__auto___19182]));

var G__19183 = (i__9058__auto___19182 + (1));
i__9058__auto___19182 = G__19183;
continue;
} else {
}
break;
...
return day8.re_frame_10x.subs._PLUS_nil.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__9077__auto__);
...
day8.re_frame_10x.subs._PLUS_nil.cljs$lang$applyTo = (function (seq19176){
...
var map__19195 = cljs.core.get.call(null,match,new cljs.core.Keyword(null,"timing","timing",-1849225195));
...
var event_time = cljs.core.get.call(null,map__19195__$1,new cljs.core.Keyword("re-frame","event-time","re-frame/event-time",-1349372188));
var event_handler_time = cljs.core.get.call(null,map__19195__$1,new cljs.core.Keyword("re-frame","event-handler-time","re-frame/event-handler-time",1278050644));
var event_dofx_time = cljs.core.get.call(null,map__19195__$1,new cljs.core.Keyword("re-frame","event-dofx-time","re-frame/event-dofx-time",650880716));
var event_run_time = cljs.core.get.call(null,map__19195__$1,new cljs.core.Keyword("re-frame","event-run-time","re-frame/event-run-time",1941554897));
...
return !(cljs.core.empty_QMARK_.call(null,p1__19197_SHARP_));
})], null),null);
...
cljs.spec.alpha.def_impl.call(null,new cljs.core.Keyword("subs","view-subs","subs/view-subs",253084832),cljs.core.list(new cljs.core.Symbol("cljs.spec.alpha","coll-of","cljs.spec.alpha/coll-of",1019430407,null),new cljs.core.Keyword("subs","view-panel-sub","subs/view-panel-sub",-1872730057)),cljs.spec.alpha.every_impl.call(null,new cljs.core.Keyword("subs","view-panel-sub","subs/view-panel-sub",-1872730057),new cljs.core.Keyword("subs","view-panel-sub","subs/view-panel-sub",-1872730057),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword("cljs.spec.alpha","kind-form","cljs.spec.alpha/kind-form",-1047104697),null,new cljs.core.Keyword("cljs.spec.alpha","cpred","cljs.spec.alpha/cpred",-693471218),(function (G__19200){
return cljs.core.coll_QMARK_.call(null,G__19200);
...
var G__19203 = (exp - (1));
var G__19204 = (total + (day8.re_frame_10x.subs.sub_type_value.call(null,sub_type) * Math.pow((10),exp)));
var G__19205 = cljs.core.rest.call(null,order__$1);
exp = G__19203;
total = G__19204;
order__$1 = G__19205;
continue;
...
var G__19206 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(t);
 ...
 */
day8.re_frame_10x.subs.prepare_pod_info = (function day8$re_frame_10x$subs$prepare_pod_info(p__19208,p__19209){
var vec__19210 = p__19208;
var sub_info = cljs.core.nth.call(null,vec__19210,(0),null);
var sub_state = cljs.core.nth.call(null,vec__19210,(1),null);
var vec__19213 = p__19209;
var subscription = cljs.core.nth.call(null,vec__19213,(0),null);
var remove_fn = ((cljs.core._EQ_.call(null,subscription,new cljs.core.Keyword("subs","inter-epoch-subs","subs/inter-epoch-subs",-83233716)))?((function (vec__19210,sub_info,sub_state,vec__19213,subscription){
return (function (me){
return (new cljs.core.Keyword(null,"order","order",-1254677256).cljs$core$IFn$_invoke$arity$1(cljs.core.val.call(null,me)) == null);
});})(vec__19210,sub_info,sub_state,vec__19213,subscription))
:cljs.core.constantly.call(null,false));
var subx = cljs.core.sort_by.call(null,new cljs.core.Keyword(null,"order","order",-1254677256),day8.re_frame_10x.subs.sub_sort_val,cljs.core.map.call(null,((function (remove_fn,vec__19210,sub_info,sub_state,vec__19213,subscription){
return (function (me){
...
return sub__$2;
});})(remove_fn,vec__19210,sub_info,sub_state,vec__19213,subscription))
...
mranderson047.re_frame.v0v10v2.re_frame.core.reg_sub.call(null,new cljs.core.Keyword("subs","visible-subs","subs/visible-subs",-1536647862),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("subs","all-subs","subs/all-subs",1599770325)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("subs","ignore-unchanged-l2-subs?","subs/ignore-unchanged-l2-subs?",-1438622704)], null),(function (p__19216){
var vec__19217 = p__19216;
var all_subs = cljs.core.nth.call(null,vec__19217,(0),null);
var ignore_unchanged_l2_QMARK_ = cljs.core.nth.call(null,vec__19217,(1),null);
