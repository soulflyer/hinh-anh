...
var len__9057__auto___21266 = arguments.length;
var i__9058__auto___21267 = (0);
while(true){
if((i__9058__auto___21267 < len__9057__auto___21266)){
args__9064__auto__.push((arguments[i__9058__auto___21267]));

var G__21268 = (i__9058__auto___21267 + (1));
i__9058__auto___21267 = G__21268;
continue;
} else {
}
break;
...
return day8.re_frame_10x.view.settings.closeable_text_box.cljs$core$IFn$_invoke$arity$variadic(argseq__9065__auto__);
});

day8.re_frame_10x.view.settings.closeable_text_box.cljs$core$IFn$_invoke$arity$variadic = (function (p__21263){
...
var model = cljs.core.get.call(null,map__21264__$1,new cljs.core.Keyword(null,"model","model",331153215));
var width = cljs.core.get.call(null,map__21264__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var on_close = cljs.core.get.call(null,map__21264__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var on_change = cljs.core.get.call(null,map__21264__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
day8.re_frame_10x.view.settings.closeable_text_box.cljs$lang$applyTo = (function (seq21262){
return day8.re_frame_10x.view.settings.closeable_text_box.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq21262));
});
...
return mranderson047.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","set-number-of-retained-epochs","settings/set-number-of-retained-epochs",-1910736736),p1__21269_SHARP_], null));
...
return mranderson047.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","app-db-follows-events?","settings/app-db-follows-events?",-115495889),p1__21270_SHARP_], null));
...
})], null)], null)], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"width","width",-384071477),day8.re_frame_10x.view.settings.comp_section_width,new cljs.core.Keyword(null,"gap","gap",80255254),day8.re_frame_10x.view.settings.vertical_gap,new cljs.core.Keyword(null,"children","children",-940561982),(function (){var iter__8703__auto__ = (function day8$re_frame_10x$view$settings$render_$_iter__21275(s__21276){
...
var c__8701__auto__ = cljs.core.chunk_first.call(null,s__21276__$2);
var size__8702__auto__ = cljs.core.count.call(null,c__8701__auto__);
var b__21278 = cljs.core.chunk_buffer.call(null,size__8702__auto__);
if((function (){var i__21277 = (0);
while(true){
if((i__21277 < size__8702__auto__)){
var item = cljs.core._nth.call(null,c__8701__auto__,i__21277);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
cljs.core.chunk_append.call(null,b__21278,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"event-str","event-str",381347778).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"212px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (i__21277,id,item,c__8701__auto__,size__8702__auto__,b__21278,s__21276__$2,temp__4657__auto__){
return (function (){
...
});})(i__21277,id,item,c__8701__auto__,size__8702__auto__,b__21278,s__21276__$2,temp__4657__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__21277,id,item,c__8701__auto__,size__8702__auto__,b__21278,s__21276__$2,temp__4657__auto__){
return (function (p1__21271_SHARP_){
return mranderson047.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-ignored-event","settings/update-ignored-event",-407164743),id,p1__21271_SHARP_], null));
});})(i__21277,id,item,c__8701__auto__,size__8702__auto__,b__21278,s__21276__$2,temp__4657__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__21283 = (i__21277 + (1));
i__21277 = G__21283;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__21278),day8$re_frame_10x$view$settings$render_$_iter__21275.call(null,cljs.core.chunk_rest.call(null,s__21276__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__21278),null);
}
} else {
var item = cljs.core.first.call(null,s__21276__$2);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"event-str","event-str",381347778).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"212px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (id,item,s__21276__$2,temp__4657__auto__){
return (function (){
return mranderson047.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","remove-ignored-event","settings/remove-ignored-event",-391073521),id], null));
});})(id,item,s__21276__$2,temp__4657__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (id,item,s__21276__$2,temp__4657__auto__){
return (function (p1__21271_SHARP_){
return mranderson047.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-ignored-event","settings/update-ignored-event",-407164743),id,p1__21271_SHARP_], null));
});})(id,item,s__21276__$2,temp__4657__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame_10x$view$settings$render_$_iter__21275.call(null,cljs.core.rest.call(null,s__21276__$2)));
}
} else {
return null;
}
...
return iter__8703__auto__.call(null,cljs.core.deref.call(null,mranderson047.re_frame.v0v10v2.re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","ignored-events","settings/ignored-events",1377799632)], null))));
...
})], null)], null)], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"width","width",-384071477),day8.re_frame_10x.view.settings.comp_section_width,new cljs.core.Keyword(null,"gap","gap",80255254),day8.re_frame_10x.view.settings.vertical_gap,new cljs.core.Keyword(null,"children","children",-940561982),(function (){var iter__8703__auto__ = (function day8$re_frame_10x$view$settings$render_$_iter__21279(s__21280){
return (new cljs.core.LazySeq(null,(function (){
var s__21280__$1 = s__21280;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__21280__$1);
if(temp__4657__auto__){
var s__21280__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__21280__$2)){
var c__8701__auto__ = cljs.core.chunk_first.call(null,s__21280__$2);
var size__8702__auto__ = cljs.core.count.call(null,c__8701__auto__);
var b__21282 = cljs.core.chunk_buffer.call(null,size__8702__auto__);
if((function (){var i__21281 = (0);
while(true){
if((i__21281 < size__8702__auto__)){
var item = cljs.core._nth.call(null,c__8701__auto__,i__21281);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
cljs.core.chunk_append.call(null,b__21282,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"ns-str","ns-str",-2062616499).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"343px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (i__21281,id,item,c__8701__auto__,size__8702__auto__,b__21282,s__21280__$2,temp__4657__auto__){
return (function (){
...
});})(i__21281,id,item,c__8701__auto__,size__8702__auto__,b__21282,s__21280__$2,temp__4657__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__21281,id,item,c__8701__auto__,size__8702__auto__,b__21282,s__21280__$2,temp__4657__auto__){
return (function (p1__21272_SHARP_){
return mranderson047.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-filtered-view-trace","settings/update-filtered-view-trace",-530575796),id,p1__21272_SHARP_], null));
});})(i__21281,id,item,c__8701__auto__,size__8702__auto__,b__21282,s__21280__$2,temp__4657__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__21284 = (i__21281 + (1));
i__21281 = G__21284;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__21282),day8$re_frame_10x$view$settings$render_$_iter__21279.call(null,cljs.core.chunk_rest.call(null,s__21280__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__21282),null);
}
} else {
var item = cljs.core.first.call(null,s__21280__$2);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"ns-str","ns-str",-2062616499).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"343px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (id,item,s__21280__$2,temp__4657__auto__){
return (function (){
return mranderson047.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","remove-filtered-view-trace","settings/remove-filtered-view-trace",970685301),id], null));
});})(id,item,s__21280__$2,temp__4657__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (id,item,s__21280__$2,temp__4657__auto__){
return (function (p1__21272_SHARP_){
return mranderson047.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-filtered-view-trace","settings/update-filtered-view-trace",-530575796),id,p1__21272_SHARP_], null));
});})(id,item,s__21280__$2,temp__4657__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame_10x$view$settings$render_$_iter__21279.call(null,cljs.core.rest.call(null,s__21280__$2)));
}
} else {
return null;
}
...
return iter__8703__auto__.call(null,cljs.core.deref.call(null,mranderson047.re_frame.v0v10v2.re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","filtered-view-trace","settings/filtered-view-trace",818098350)], null))));
...
return mranderson047.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","low-level-trace","settings/low-level-trace",191054289),new cljs.core.Keyword(null,"reagent","reagent",2131627322),p1__21273_SHARP_], null));
});})(low_level_trace))
