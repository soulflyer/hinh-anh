...
ajax.transit.transit_type = (function ajax$transit$transit_type(p__54827){
...
var type = cljs.core.get.call(null,map__54828__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var or__46739__auto__ = type;
...
var writer = (function (){var or__46739__auto__ = new cljs.core.Keyword(null,"writer","writer",-277568236).cljs$core$IFn$_invoke$arity$1(request);
if(cljs.core.truth_(or__46739__auto__)){
return or__46739__auto__;
} else {
...
var reader = (function (){var or__46739__auto__ = new cljs.core.Keyword(null,"reader","reader",169660853).cljs$core$IFn$_invoke$arity$1(request);
if(cljs.core.truth_(or__46739__auto__)){
return or__46739__auto__;
} else {
