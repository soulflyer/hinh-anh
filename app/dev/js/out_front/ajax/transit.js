...
ajax.transit.transit_type = (function ajax$transit$transit_type(p__17518){
var map__17521 = p__17518;
var map__17521__$1 = ((((!((map__17521 == null)))?((((map__17521.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__17521.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__17521):map__17521);
var type = cljs.core.get.call(null,map__17521__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var args17523 = [];
var len__8057__auto___17526 = arguments.length;
var i__8058__auto___17527 = (0);
while(true){
if((i__8058__auto___17527 < len__8057__auto___17526)){
args17523.push((arguments[i__8058__auto___17527]));

var G__17528 = (i__8058__auto___17527 + (1));
i__8058__auto___17527 = G__17528;
continue;
} else {
}
break;
...
var args17530 = [];
var len__8057__auto___17533 = arguments.length;
var i__8058__auto___17534 = (0);
while(true){
if((i__8058__auto___17534 < len__8057__auto___17533)){
args17530.push((arguments[i__8058__auto___17534]));

var G__17535 = (i__8058__auto___17534 + (1));
i__8058__auto___17534 = G__17535;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args17530.length)].join('')));
