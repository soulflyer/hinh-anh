...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__54856){
var map__54857 = p__54856;
var map__54857__$1 = ((((!((map__54857 == null)))?((((map__54857.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54857.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__54857):map__54857);
var handler = cljs.core.get.call(null,map__54857__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return (function (p1__54859_SHARP_){
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__46739__auto__ = p1__54859_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__54860){
...
var request = map__54861__$1;
var interceptors = cljs.core.get.call(null,map__54861__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
...
var api = (function (){var or__46739__auto__ = new cljs.core.Keyword(null,"api","api",-899839580).cljs$core$IFn$_invoke$arity$1(request__$1);
if(cljs.core.truth_(or__46739__auto__)){
return or__46739__auto__;
} else {
