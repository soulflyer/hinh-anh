...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__59637 = cljs.core.instance_QMARK_;
var expr__59638 = reactive_val;
if(cljs.core.truth_(pred__59637.call(null,mranderson047.reagent.v0v7v0.reagent.ratom.RAtom,expr__59638))){
return "ra";
} else {
if(cljs.core.truth_(pred__59637.call(null,mranderson047.reagent.v0v7v0.reagent.ratom.RCursor,expr__59638))){
return "rc";
} else {
if(cljs.core.truth_(pred__59637.call(null,mranderson047.reagent.v0v7v0.reagent.ratom.Reaction,expr__59638))){
return "rx";
} else {
if(cljs.core.truth_(pred__59637.call(null,mranderson047.reagent.v0v7v0.reagent.ratom.Track,expr__59638))){
return "tr";
} else {
return "other";
}
