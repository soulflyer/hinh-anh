...
var base_style__$1 = (cljs.core.truth_((function (){var and__46727__auto__ = selected_QMARK_;
...
var base_style__$2 = (cljs.core.truth_((function (){var and__46727__auto__ = selected_QMARK_;
if(cljs.core.truth_(and__46727__auto__)){
...
if(cljs.core.truth_((function (){var and__46727__auto__ = required_QMARK_;
if(cljs.core.truth_(and__46727__auto__)){
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__53597){
var map__53598 = p__53597;
var map__53598__$1 = ((((!((map__53598 == null)))?((((map__53598.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53598.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__53598):map__53598);
var args = map__53598__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__53598__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__53598__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var item_renderer = cljs.core.get.call(null,map__53598__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__53598__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__53598__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__53598__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__53598__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var hide_border_QMARK_ = cljs.core.get.call(null,map__53598__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var choices = cljs.core.get.call(null,map__53598__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__53598__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__53598__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__53598,map__53598__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__53594_SHARP_){
return item_renderer.call(null,p1__53594_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__53598,map__53598__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__53598,map__53598__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__53595_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__53595_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__53598,map__53598__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__53598,map__53598__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__53596_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__53596_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__53598,map__53598__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__47901__auto___53607 = arguments.length;
var i__47902__auto___53608 = (0);
while(true){
if((i__47902__auto___53608 < len__47901__auto___53607)){
args__47908__auto__.push((arguments[i__47902__auto___53608]));

var G__53609 = (i__47902__auto___53608 + (1));
i__47902__auto___53608 = G__53609;
continue;
} else {
}
break;
...
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(argseq__47909__auto__);
});

re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__53601){
var map__53602 = p__53601;
var map__53602__$1 = ((((!((map__53602 == null)))?((((map__53602.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53602.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__53602):map__53602);
var args = map__53602__$1;

return ((function (map__53602,map__53602__$1,args){
return (function() { 
var G__53610__delegate = function (p__53604){
var map__53605 = p__53604;
var map__53605__$1 = ((((!((map__53605 == null)))?((((map__53605.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53605.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__53605):map__53605);
var args__$1 = map__53605__$1;
...
var G__53610 = function (var_args){
var p__53604 = null;
if (arguments.length > 0) {
var G__53611__i = 0, G__53611__a = new Array(arguments.length -  0);
while (G__53611__i < G__53611__a.length) {G__53611__a[G__53611__i] = arguments[G__53611__i + 0]; ++G__53611__i;}
  p__53604 = new cljs.core.IndexedSeq(G__53611__a,0,null);
} 
return G__53610__delegate.call(this,p__53604);};
G__53610.cljs$lang$maxFixedArity = 0;
G__53610.cljs$lang$applyTo = (function (arglist__53612){
var p__53604 = cljs.core.seq(arglist__53612);
return G__53610__delegate(p__53604);
});
G__53610.cljs$core$IFn$_invoke$arity$variadic = G__53610__delegate;
return G__53610;
})()
;
;})(map__53602,map__53602__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq53600){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq53600));
});
