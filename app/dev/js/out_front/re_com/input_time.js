 ...
 */
re_com.input_time.triple__GT_time = (function re_com$input_time$triple__GT_time(p__49676){
var vec__49677 = p__49676;
var hr = cljs.core.nth.call(null,vec__49677,(0),null);
var _ = cljs.core.nth.call(null,vec__49677,(1),null);
var mi = cljs.core.nth.call(null,vec__49677,(2),null);
return ((hr * (100)) + mi);
});
...
if(cljs.core.truth_((function (){var and__46727__auto__ = callback;
...
var len__47901__auto___49687 = arguments.length;
var i__47902__auto___49688 = (0);
while(true){
if((i__47902__auto___49688 < len__47901__auto___49687)){
args__47908__auto__.push((arguments[i__47902__auto___49688]));

var G__49689 = (i__47902__auto___49688 + (1));
i__47902__auto___49688 = G__49689;
continue;
} else {
}
break;
...
return re_com.input_time.input_time.cljs$core$IFn$_invoke$arity$variadic(argseq__47909__auto__);
});

re_com.input_time.input_time.cljs$core$IFn$_invoke$arity$variadic = (function (p__49681){
var map__49682 = p__49681;
var map__49682__$1 = ((((!((map__49682 == null)))?((((map__49682.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__49682.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__49682):map__49682);
var args = map__49682__$1;
var model = cljs.core.get.call(null,map__49682__$1,new cljs.core.Keyword(null,"model","model",331153215));
var minimum = cljs.core.get.call(null,map__49682__$1,new cljs.core.Keyword(null,"minimum","minimum",-1621006059),(0));
var maximum = cljs.core.get.call(null,map__49682__$1,new cljs.core.Keyword(null,"maximum","maximum",573880714),(2359));
var on_change = cljs.core.get.call(null,map__49682__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var class$ = cljs.core.get.call(null,map__49682__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var style = cljs.core.get.call(null,map__49682__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var attr = cljs.core.get.call(null,map__49682__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
...
return ((function (deref_model,text_model,previous_model,map__49682,map__49682__$1,args,model,minimum,maximum,on_change,class$,style,attr){
return (function() { 
var G__49690__delegate = function (p__49684){
var map__49685 = p__49684;
var map__49685__$1 = ((((!((map__49685 == null)))?((((map__49685.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__49685.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__49685):map__49685);
var args__$1 = map__49685__$1;
var model__$1 = cljs.core.get.call(null,map__49685__$1,new cljs.core.Keyword(null,"model","model",331153215));
var minimum__$1 = cljs.core.get.call(null,map__49685__$1,new cljs.core.Keyword(null,"minimum","minimum",-1621006059),(0));
var maximum__$1 = cljs.core.get.call(null,map__49685__$1,new cljs.core.Keyword(null,"maximum","maximum",573880714),(2359));
var width = cljs.core.get.call(null,map__49685__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.call(null,map__49685__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var disabled_QMARK_ = cljs.core.get.call(null,map__49685__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var hide_border_QMARK_ = cljs.core.get.call(null,map__49685__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var show_icon_QMARK_ = cljs.core.get.call(null,map__49685__$1,new cljs.core.Keyword(null,"show-icon?","show-icon?",-756836459));
...
,new cljs.core.Keyword(null,"on-key-up","on-key-up",884441808),((function (style__$1,new_val,new_val__$1,new_val__$2,map__49685,map__49685__$1,args__$1,model__$1,minimum__$1,maximum__$1,width,height,disabled_QMARK_,hide_border_QMARK_,show_icon_QMARK_,deref_model,text_model,previous_model,map__49682,map__49682__$1,args,model,minimum,maximum,on_change,class$,style,attr){
return (function (event){
...
while (G__49691__i < G__49691__a.length) {G__49691__a[G__49691__i] = arguments[G__49691__i + 0]; ++G__49691__i;}
  p__49684 = new cljs.core.IndexedSeq(G__49691__a,0,null);
} 
return G__49690__delegate.call(this,p__49684);};
G__49690.cljs$lang$maxFixedArity = 0;
G__49690.cljs$lang$applyTo = (function (arglist__49692){
var p__49684 = cljs.core.seq(arglist__49692);
return G__49690__delegate(p__49684);
});
G__49690.cljs$core$IFn$_invoke$arity$variadic = G__49690__delegate;
return G__49690;
})()
;
;})(deref_model,text_model,previous_model,map__49682,map__49682__$1,args,model,minimum,maximum,on_change,class$,style,attr))
});

re_com.input_time.input_time.cljs$lang$maxFixedArity = (0);

re_com.input_time.input_time.cljs$lang$applyTo = (function (seq49680){
return re_com.input_time.input_time.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq49680));
});
