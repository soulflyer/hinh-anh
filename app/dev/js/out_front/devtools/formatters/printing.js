...
var len__47901__auto___61969 = arguments.length;
var i__47902__auto___61970 = (0);
while(true){
if((i__47902__auto___61970 < len__47901__auto___61969)){
args__47908__auto__.push((arguments[i__47902__auto___61970]));

var G__61971 = (i__47902__auto___61970 + (1));
i__47902__auto___61970 = G__61971;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__47909__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq61966){
var G__61967 = cljs.core.first.call(null,seq61966);
var seq61966__$1 = cljs.core.next.call(null,seq61966);
var G__61968 = cljs.core.first.call(null,seq61966__$1);
var seq61966__$2 = cljs.core.next.call(null,seq61966__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__61967,G__61968,seq61966__$2);
});
...
if(cljs.core.truth_((function (){var or__46739__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__47364__auto__,writer__47365__auto__,opt__47366__auto__){
return cljs.core._write.call(null,writer__47365__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__46727__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__46727__auto__){
var or__46739__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__46739__auto__)){
return or__46739__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__61972_SHARP_){
return !((cljs.core.meta.call(null,p1__61972_SHARP_) == null));
})))){
...
var map__61973 = opts;
var map__61973__$1 = ((((!((map__61973 == null)))?((((map__61973.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__61973.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__61973):map__61973);
var markup_db = cljs.core.get.call(null,map__61973__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__46739__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e61977){var _e__61703__auto__ = e61977;
return false;
}})();
if(cljs.core.truth_(or__46739__auto__)){
return or__46739__auto__;
...
}catch (e61979){var _e__61703__auto__ = e61979;
return false;
}}
})())){
...
var _STAR_current_state_STAR_61981 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__61982 = opts;
var map__61982__$1 = ((((!((map__61982 == null)))?((((map__61982.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__61982.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__61982):map__61982);
var markup_db = cljs.core.get.call(null,map__61982__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_61981;
}});
...
;
var temp__4655__auto___61986 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___61986)){
var managed_print_level_61987 = temp__4655__auto___61986;
var _STAR_print_level_STAR_61985_61988 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_61987;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_61985_61988,managed_print_level_61987,temp__4655__auto___61986,writer,opts,job_fn){
return (function (p1__61984_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__61984_SHARP_,null);
});})(_STAR_print_level_STAR_61985_61988,managed_print_level_61987,temp__4655__auto___61986,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_61985_61988;
}} else {
job_fn.call(null);
}
