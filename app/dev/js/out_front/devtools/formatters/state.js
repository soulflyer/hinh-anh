...
var len__47901__auto___61960 = arguments.length;
var i__47902__auto___61961 = (0);
while(true){
if((i__47902__auto___61961 < len__47901__auto___61960)){
args__47908__auto__.push((arguments[i__47902__auto___61961]));

var G__61962 = (i__47902__auto___61961 + (1));
i__47902__auto___61961 = G__61962;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__47909__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq61958){
var G__61959 = cljs.core.first.call(null,seq61958);
var seq61958__$1 = cljs.core.next.call(null,seq61958);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__61959,seq61958__$1);
});
...
return (function (p1__61963_SHARP_){
return (p1__61963_SHARP_ === object);
});})(history))
,history);
});
