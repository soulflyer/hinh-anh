...
var and__46727__auto__ = cljs.core.not.call(null,devtools.formatters.state.prevent_recursion_QMARK_.call(null));
if(and__46727__auto__){
var or__46739__auto__ = devtools.formatters.helpers.cljs_value_QMARK_.call(null,value);
...
}catch (e63441){var _e__61703__auto__ = e63441;
return false;
...
}catch (e63443){var _e__61703__auto__ = e63443;
return false;
...
}catch (e63445){var _e__61703__auto__ = e63445;
return false;
...
}catch (e63447){var _e__61703__auto__ = e63447;
return false;
...
}catch (e63449){var _e__61703__auto__ = e63449;
return false;
}})())){
...
}catch (e63451){var _e__61703__auto__ = e63451;
return false;
}})())){
...
var _STAR_current_state_STAR_63453 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = (function (){var or__46739__auto__ = config;
if(cljs.core.truth_(or__46739__auto__)){
return or__46739__auto__;
} else {
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_63453;
}});
});
...
return (function() { 
var G__63455__delegate = function (args){
try{return cljs.core.apply.call(null,f,args);
}catch (e63454){var e = e63454;
devtools.reporter.report_internal_error_BANG_.call(null,e,"an exception was raised during value formatting");

return null;
}};
var G__63455 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__63456__i = 0, G__63456__a = new Array(arguments.length -  0);
while (G__63456__i < G__63456__a.length) {G__63456__a[G__63456__i] = arguments[G__63456__i + 0]; ++G__63456__i;}
  args = new cljs.core.IndexedSeq(G__63456__a,0,null);
} 
return G__63455__delegate.call(this,args);};
G__63455.cljs$lang$maxFixedArity = 0;
G__63455.cljs$lang$applyTo = (function (arglist__63457){
var args = cljs.core.seq(arglist__63457);
return G__63455__delegate(args);
});
G__63455.cljs$core$IFn$_invoke$arity$variadic = G__63455__delegate;
return G__63455;
})()
;
});
...
var pre_handler = (function (){var or__46739__auto__ = devtools.prefs.pref.call(null,pre_handler_key);
if(cljs.core.truth_(or__46739__auto__)){
return or__46739__auto__;
} else {
...
var post_handler = (function (){var or__46739__auto__ = devtools.prefs.pref.call(null,post_handler_key);
if(cljs.core.truth_(or__46739__auto__)){
return or__46739__auto__;
} else {
return cljs.core.identity;
