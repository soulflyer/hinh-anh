...
var G__61940 = devtools.prefs.pref.call(null,v);
v = G__61940;
continue;
} else {
return v;
...
var and__46727__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__46727__auto__){
var and__46727__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__46739__auto__ = (function (){try{if(!((value == null))){
...
}catch (e61943){var _e__61703__auto__ = e61943;
return false;
}})();
if(cljs.core.truth_(or__46739__auto__)){
return or__46739__auto__;
} else {
var or__46739__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e61947){var _e__61703__auto__ = e61947;
return false;
}})();
...
}catch (e61949){var _e__61703__auto__ = e61949;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__46727__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__46727__auto__)){
var and__46727__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__46727__auto____$1){
...
var and__46727__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__46727__auto__)){
...
var or__46739__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__46739__auto__)){
return or__46739__auto__;
} else {
...
var and__46727__auto__ = (function (){var or__46739__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__46739__auto__)){
return or__46739__auto__;
} else {
...
var vec__61951 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__61951,(0),null);
var name = cljs.core.nth.call(null,vec__61951,(1),null);
...
var and__46727__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__46727__auto__)){
...
var or__46739__auto__ = typeof value === 'string';
if(or__46739__auto__){
return or__46739__auto__;
} else {
var or__46739__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__61954_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__61954_SHARP_);
}),template);
});
