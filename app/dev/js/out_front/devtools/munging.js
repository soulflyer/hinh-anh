...
var o61838 = temp__4655__auto__;
var temp__4655__auto____$1 = (o61838["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o61839 = temp__4655__auto____$1;
return (o61839["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__61696__auto__ = f;
return (o__61696__auto__["toString"]).call(o__61696__auto__);
} else {
return "";
}
}catch (e61840){var _ = e61840;
return "";
}});
...
try{var o__61696__auto___61842 = t;
(o__61696__auto___61842["cljs$lang$ctorPrWriter"]).call(o__61696__auto___61842,t,writer);
}catch (e61841){var __61843 = e61841;
}
...
var char_code = (function (){var o__61696__auto__ = (new String(char$));
return (o__61696__auto__["charCodeAt"]).call(o__61696__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__61696__auto__ = String;
return (o__61696__auto__["fromCharCode"]).call(o__61696__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__61844 = num_code;
switch (G__61844) {
case (1):
return (185);
...
var o__61696__auto__ = String;
return (o__61696__auto__["fromCharCode"]).call(o__61696__auto__,superscript_code);
});
/**
...
}catch (e61846){var _e__61703__auto__ = e61846;
return false;
}})())){
...
var vec__61847 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__61847,(0),null);
...
var or__46739__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
if(cljs.core.truth_(temp__4655__auto__)){
var o61850 = temp__4655__auto__;
var temp__4655__auto____$1 = (o61850["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o61851 = temp__4655__auto____$1;
return (o61851["nameToPath"]);
} else {
return null;
}
} else {
...
var len__47901__auto___61858 = arguments.length;
var i__47902__auto___61859 = (0);
while(true){
if((i__47902__auto___61859 < len__47901__auto___61858)){
args__47908__auto__.push((arguments[i__47902__auto___61859]));

var G__61860 = (i__47902__auto___61859 + (1));
i__47902__auto___61859 = G__61860;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__47909__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__61854){
var vec__61855 = p__61854;
var ns_detector = cljs.core.nth.call(null,vec__61855,(0),null);
var effective_detector = (function (){var or__46739__auto__ = ns_detector;
if(cljs.core.truth_(or__46739__auto__)){
return or__46739__auto__;
} else {
...
var G__61861 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__61862 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__61861;
remaining_tokens = G__61862;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq61852){
var G__61853 = cljs.core.first.call(null,seq61852);
var seq61852__$1 = cljs.core.next.call(null,seq61852);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__61853,seq61852__$1);
});
...
var vec__61866 = cljs.core.split_with.call(null,(function (p1__61865_SHARP_){
return cljs.core.not_EQ_.call(null,p1__61865_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__61866,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__61866,(1),null);
...
var vec__61869 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__61869,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__61869,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__61872 = cljs.core.rest.call(null,remaining_tokens);
var G__61873 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__61872;
name_tokens = G__61873;
continue;
} else {
...
var vec__61876 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__61876,(0),null);
var arity = cljs.core.nth.call(null,vec__61876,(1),null);
var vec__61879 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__61879,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__61879,(1),null);
var vec__61882 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__61882,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__61882,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__61882,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__61882,(3),null);
...
var vec__61888 = result;
var munged_ns = cljs.core.nth.call(null,vec__61888,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__61888,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__61888,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__61888,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__61888,(4),null);
var arity = cljs.core.nth.call(null,vec__61888,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__61892 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__61892,(0),null);
var args = cljs.core.nth.call(null,vec__61892,(1),null);
var vec__61895 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__61895,(0),null);
var name = cljs.core.nth.call(null,vec__61895,(1),null);
...
var G__61898 = (arity + (1));
var G__61899 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__61900){
var vec__61901 = p__61900;
var arity = cljs.core.nth.call(null,vec__61901,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__61901,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__46739__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__46739__auto__)){
return or__46739__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__61904_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__61905_SHARP_){
return cljs.core.drop.call(null,(2),p1__61905_SHARP_);
...
var args__47908__auto__ = [];
var len__47901__auto___61912 = arguments.length;
var i__47902__auto___61913 = (0);
while(true){
if((i__47902__auto___61913 < len__47901__auto___61912)){
args__47908__auto__.push((arguments[i__47902__auto___61913]));

var G__61914 = (i__47902__auto___61913 + (1));
i__47902__auto___61913 = G__61914;
continue;
} else {
}
break;
...
var argseq__47909__auto__ = ((((1) < args__47908__auto__.length))?(new cljs.core.IndexedSeq(args__47908__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__47909__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__61908){
var vec__61909 = p__61908;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__61909,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq61906){
var G__61907 = cljs.core.first.call(null,seq61906);
var seq61906__$1 = cljs.core.next.call(null,seq61906);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__61907,seq61906__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__46739__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__46739__auto__)){
return or__46739__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__46727__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__46739__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__46739__auto__)){
return or__46739__auto__;
} else {
...
var map__61917 = options;
var map__61917__$1 = ((((!((map__61917 == null)))?((((map__61917.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__61917.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__61917):map__61917);
var include_ns_QMARK_ = cljs.core.get.call(null,map__61917__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__61917__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__61917__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__61917__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__61918 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__61918,(0),null);
var fn_name = cljs.core.nth.call(null,vec__61918,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__61918,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__61918,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__61918,(4),null);
var arity = cljs.core.nth.call(null,vec__61918,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__46727__auto__ = protocol_ns;
if(cljs.core.truth_(and__46727__auto__)){
return cljs.core.not.call(null,(function (){var and__46727__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__46739__auto__ = protocol_part;
if(cljs.core.truth_(or__46739__auto__)){
return or__46739__auto__;
} else {
return fn_part;
...
var o__61696__auto__ = f;
return (o__61696__auto__["getBasis"]).call(o__61696__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__46727__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__46727__auto__)){
...
}catch (e61922){var _e__61703__auto__ = e61922;
...
var G__61923 = (obj[cljs.core.first.call(null,path)]);
var G__61924 = cljs.core.rest.call(null,path);
obj = G__61923;
path = G__61924;
continue;
} else {
...
var partition_bits = (function (){var or__46739__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__46739__auto__)){
return or__46739__auto__;
} else {
return (0);
...
return (function (accum,p__61925){
var vec__61926 = p__61925;
var bit = cljs.core.nth.call(null,vec__61926,(0),null);
var protocol = cljs.core.nth.call(null,vec__61926,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__61929){
var vec__61930 = p__61929;
var ns = cljs.core.nth.call(null,vec__61930,(0),null);
var name = cljs.core.nth.call(null,vec__61930,(1),null);
var selector = cljs.core.nth.call(null,vec__61930,(2),null);
...
return (function (p__61934){
var vec__61935 = p__61934;
var munged_name = cljs.core.nth.call(null,vec__61935,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__61935,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__61935,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__61933_SHARP_){
return (obj[cljs.core.first.call(null,p1__61933_SHARP_)]);
});})(name,sorted_matches,vec__61935,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
