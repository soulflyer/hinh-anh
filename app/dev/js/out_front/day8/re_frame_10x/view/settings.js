...
var len__47901__auto___66343 = arguments.length;
var i__47902__auto___66344 = (0);
while(true){
if((i__47902__auto___66344 < len__47901__auto___66343)){
args__47908__auto__.push((arguments[i__47902__auto___66344]));

var G__66345 = (i__47902__auto___66344 + (1));
i__47902__auto___66344 = G__66345;
continue;
} else {
}
break;
...
return day8.re_frame_10x.view.settings.closeable_text_box.cljs$core$IFn$_invoke$arity$variadic(argseq__47909__auto__);
});

day8.re_frame_10x.view.settings.closeable_text_box.cljs$core$IFn$_invoke$arity$variadic = (function (p__66340){
var map__66341 = p__66340;
var map__66341__$1 = ((((!((map__66341 == null)))?((((map__66341.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__66341.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__66341):map__66341);
var model = cljs.core.get.call(null,map__66341__$1,new cljs.core.Keyword(null,"model","model",331153215));
var width = cljs.core.get.call(null,map__66341__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var on_close = cljs.core.get.call(null,map__66341__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var on_change = cljs.core.get.call(null,map__66341__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
day8.re_frame_10x.view.settings.closeable_text_box.cljs$lang$applyTo = (function (seq66339){
return day8.re_frame_10x.view.settings.closeable_text_box.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq66339));
});
...
return (function (p1__66346_SHARP_){
return mranderson047.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","set-number-of-retained-epochs","settings/set-number-of-retained-epochs",-1910736736),p1__66346_SHARP_], null));
...
return (function (p1__66347_SHARP_){
return mranderson047.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","app-db-follows-events?","settings/app-db-follows-events?",-115495889),p1__66347_SHARP_], null));
...
})], null)], null)], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"width","width",-384071477),day8.re_frame_10x.view.settings.comp_section_width,new cljs.core.Keyword(null,"gap","gap",80255254),day8.re_frame_10x.view.settings.vertical_gap,new cljs.core.Keyword(null,"children","children",-940561982),(function (){var iter__47547__auto__ = (function day8$re_frame_10x$view$settings$render_$_iter__66352(s__66353){
return (new cljs.core.LazySeq(null,(function (){
var s__66353__$1 = s__66353;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__66353__$1);
if(temp__4657__auto__){
var s__66353__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__66353__$2)){
var c__47545__auto__ = cljs.core.chunk_first.call(null,s__66353__$2);
var size__47546__auto__ = cljs.core.count.call(null,c__47545__auto__);
var b__66355 = cljs.core.chunk_buffer.call(null,size__47546__auto__);
if((function (){var i__66354 = (0);
while(true){
if((i__66354 < size__47546__auto__)){
var item = cljs.core._nth.call(null,c__47545__auto__,i__66354);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
cljs.core.chunk_append.call(null,b__66355,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"event-str","event-str",381347778).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"212px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (i__66354,id,item,c__47545__auto__,size__47546__auto__,b__66355,s__66353__$2,temp__4657__auto__){
return (function (){
...
});})(i__66354,id,item,c__47545__auto__,size__47546__auto__,b__66355,s__66353__$2,temp__4657__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__66354,id,item,c__47545__auto__,size__47546__auto__,b__66355,s__66353__$2,temp__4657__auto__){
return (function (p1__66348_SHARP_){
return mranderson047.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-ignored-event","settings/update-ignored-event",-407164743),id,p1__66348_SHARP_], null));
});})(i__66354,id,item,c__47545__auto__,size__47546__auto__,b__66355,s__66353__$2,temp__4657__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__66360 = (i__66354 + (1));
i__66354 = G__66360;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__66355),day8$re_frame_10x$view$settings$render_$_iter__66352.call(null,cljs.core.chunk_rest.call(null,s__66353__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__66355),null);
}
} else {
var item = cljs.core.first.call(null,s__66353__$2);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"event-str","event-str",381347778).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"212px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (id,item,s__66353__$2,temp__4657__auto__){
return (function (){
return mranderson047.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","remove-ignored-event","settings/remove-ignored-event",-391073521),id], null));
});})(id,item,s__66353__$2,temp__4657__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (id,item,s__66353__$2,temp__4657__auto__){
return (function (p1__66348_SHARP_){
return mranderson047.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-ignored-event","settings/update-ignored-event",-407164743),id,p1__66348_SHARP_], null));
});})(id,item,s__66353__$2,temp__4657__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame_10x$view$settings$render_$_iter__66352.call(null,cljs.core.rest.call(null,s__66353__$2)));
}
} else {
return null;
}
...
return iter__47547__auto__.call(null,cljs.core.deref.call(null,mranderson047.re_frame.v0v10v2.re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","ignored-events","settings/ignored-events",1377799632)], null))));
...
})], null)], null)], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"width","width",-384071477),day8.re_frame_10x.view.settings.comp_section_width,new cljs.core.Keyword(null,"gap","gap",80255254),day8.re_frame_10x.view.settings.vertical_gap,new cljs.core.Keyword(null,"children","children",-940561982),(function (){var iter__47547__auto__ = (function day8$re_frame_10x$view$settings$render_$_iter__66356(s__66357){
return (new cljs.core.LazySeq(null,(function (){
var s__66357__$1 = s__66357;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__66357__$1);
if(temp__4657__auto__){
var s__66357__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__66357__$2)){
var c__47545__auto__ = cljs.core.chunk_first.call(null,s__66357__$2);
var size__47546__auto__ = cljs.core.count.call(null,c__47545__auto__);
var b__66359 = cljs.core.chunk_buffer.call(null,size__47546__auto__);
if((function (){var i__66358 = (0);
while(true){
if((i__66358 < size__47546__auto__)){
var item = cljs.core._nth.call(null,c__47545__auto__,i__66358);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
cljs.core.chunk_append.call(null,b__66359,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"ns-str","ns-str",-2062616499).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"343px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (i__66358,id,item,c__47545__auto__,size__47546__auto__,b__66359,s__66357__$2,temp__4657__auto__){
return (function (){
...
});})(i__66358,id,item,c__47545__auto__,size__47546__auto__,b__66359,s__66357__$2,temp__4657__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__66358,id,item,c__47545__auto__,size__47546__auto__,b__66359,s__66357__$2,temp__4657__auto__){
return (function (p1__66349_SHARP_){
return mranderson047.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-filtered-view-trace","settings/update-filtered-view-trace",-530575796),id,p1__66349_SHARP_], null));
});})(i__66358,id,item,c__47545__auto__,size__47546__auto__,b__66359,s__66357__$2,temp__4657__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__66361 = (i__66358 + (1));
i__66358 = G__66361;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__66359),day8$re_frame_10x$view$settings$render_$_iter__66356.call(null,cljs.core.chunk_rest.call(null,s__66357__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__66359),null);
}
} else {
var item = cljs.core.first.call(null,s__66357__$2);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"ns-str","ns-str",-2062616499).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"343px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (id,item,s__66357__$2,temp__4657__auto__){
return (function (){
return mranderson047.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","remove-filtered-view-trace","settings/remove-filtered-view-trace",970685301),id], null));
});})(id,item,s__66357__$2,temp__4657__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (id,item,s__66357__$2,temp__4657__auto__){
return (function (p1__66349_SHARP_){
return mranderson047.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-filtered-view-trace","settings/update-filtered-view-trace",-530575796),id,p1__66349_SHARP_], null));
});})(id,item,s__66357__$2,temp__4657__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame_10x$view$settings$render_$_iter__66356.call(null,cljs.core.rest.call(null,s__66357__$2)));
}
} else {
return null;
}
...
return iter__47547__auto__.call(null,cljs.core.deref.call(null,mranderson047.re_frame.v0v10v2.re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","filtered-view-trace","settings/filtered-view-trace",818098350)], null))));
...
return (function (p1__66350_SHARP_){
return mranderson047.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","low-level-trace","settings/low-level-trace",191054289),new cljs.core.Keyword(null,"reagent","reagent",2131627322),p1__66350_SHARP_], null));
});})(low_level_trace))
