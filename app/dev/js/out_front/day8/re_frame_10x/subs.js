...
return cljs.core.map.call(null,(function (p1__64377_SHARP_){
return cljs.core.assoc.call(null,cljs.core.val.call(null,p1__64377_SHARP_),new cljs.core.Keyword(null,"id","id",-1388402092),cljs.core.key.call(null,p1__64377_SHARP_));
...
mranderson047.re_frame.v0v10v2.re_frame.core.reg_sub.call(null,new cljs.core.Keyword("traces","current-event-traces","traces/current-event-traces",1386605769),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("traces","all-traces","traces/all-traces",-755374523)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","beginning-trace-id","epochs/beginning-trace-id",-1340593887)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","ending-trace-id","epochs/ending-trace-id",-1920901579)], null),(function (p__64382,_){
var vec__64383 = p__64382;
var traces = cljs.core.nth.call(null,vec__64383,(0),null);
var beginning = cljs.core.nth.call(null,vec__64383,(1),null);
var ending = cljs.core.nth.call(null,vec__64383,(2),null);
...
day8.re_frame_10x.subs.filter_ignored_views = (function day8$re_frame_10x$subs$filter_ignored_views(p__64386,_){
var vec__64387 = p__64386;
var traces = cljs.core.nth.call(null,vec__64387,(0),null);
var filtered_views = cljs.core.nth.call(null,vec__64387,(1),null);
...
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.remove.call(null,((function (munged_ns,vec__64387,traces,filtered_views){
return (function (trace){
var and__46727__auto__ = day8.re_frame_10x.metamorphic.render_QMARK_.call(null,trace);
...
});})(munged_ns,vec__64387,traces,filtered_views))
),traces);
});
...
mranderson047.re_frame.v0v10v2.re_frame.core.reg_sub.call(null,new cljs.core.Keyword("epochs","current-match-state","epochs/current-match-state",-1577612281),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","epoch-root","epochs/epoch-root",-2097634597)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","match-ids","epochs/match-ids",-669448057)], null),(function (p__64390,_){
var vec__64391 = p__64390;
var epochs = cljs.core.nth.call(null,vec__64391,(0),null);
var match_ids = cljs.core.nth.call(null,vec__64391,(1),null);
...
mranderson047.re_frame.v0v10v2.re_frame.core.reg_sub.call(null,new cljs.core.Keyword("epochs","older-epochs-available?","epochs/older-epochs-available?",366051335),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","current-epoch-id","epochs/current-epoch-id",-482598682)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","match-ids","epochs/match-ids",-669448057)], null),(function (p__64394){
var vec__64395 = p__64394;
var current = cljs.core.nth.call(null,vec__64395,(0),null);
var ids = cljs.core.nth.call(null,vec__64395,(1),null);
return (((1) < cljs.core.count.call(null,ids))) && (((current == null)) || ((current > cljs.core.nth.call(null,ids,(0)))));
}));
mranderson047.re_frame.v0v10v2.re_frame.core.reg_sub.call(null,new cljs.core.Keyword("epochs","newer-epochs-available?","epochs/newer-epochs-available?",-1411103953),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","current-epoch-id","epochs/current-epoch-id",-482598682)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","match-ids","epochs/match-ids",-669448057)], null),(function (p__64398){
var vec__64399 = p__64398;
var current = cljs.core.nth.call(null,vec__64399,(0),null);
var ids = cljs.core.nth.call(null,vec__64399,(1),null);
...
return cljs.core.filter.call(null,(function (p1__64402_SHARP_){
var or__46739__auto__ = day8.re_frame_10x.metamorphic.request_animation_frame_QMARK_.call(null,p1__64402_SHARP_);
if(cljs.core.truth_(or__46739__auto__)){
return or__46739__auto__;
} else {
return day8.re_frame_10x.metamorphic.request_animation_frame_end_QMARK_.call(null,p1__64402_SHARP_);
}
}),traces);
}));
...
var len__47901__auto___64409 = arguments.length;
var i__47902__auto___64410 = (0);
while(true){
if((i__47902__auto___64410 < len__47901__auto___64409)){
args_arr__47920__auto__.push((arguments[i__47902__auto___64410]));

var G__64411 = (i__47902__auto___64410 + (1));
i__47902__auto___64410 = G__64411;
continue;
} else {
}
break;
...
return day8.re_frame_10x.subs._PLUS_nil.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__47921__auto__);
...
day8.re_frame_10x.subs._PLUS_nil.cljs$lang$applyTo = (function (seq64404){
var G__64405 = cljs.core.first.call(null,seq64404);
var seq64404__$1 = cljs.core.next.call(null,seq64404);
var G__64406 = cljs.core.first.call(null,seq64404__$1);
var seq64404__$2 = cljs.core.next.call(null,seq64404__$1);
return day8.re_frame_10x.subs._PLUS_nil.cljs$core$IFn$_invoke$arity$variadic(G__64405,G__64406,seq64404__$2);
});

day8.re_frame_10x.subs._PLUS_nil.cljs$lang$maxFixedArity = (2);

mranderson047.re_frame.v0v10v2.re_frame.core.reg_sub.call(null,new cljs.core.Keyword("timing","animation-frame-time","timing/animation-frame-time",1905393593),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("timing","animation-frame-traces","timing/animation-frame-traces",394987473)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("traces","current-event-traces","traces/current-event-traces",1386605769)], null),(function (p__64412,p__64413){
var vec__64414 = p__64412;
var af_start_end = cljs.core.nth.call(null,vec__64414,(0),null);
var epoch_traces = cljs.core.nth.call(null,vec__64414,(1),null);
var vec__64417 = p__64413;
var _ = cljs.core.nth.call(null,vec__64417,(0),null);
var frame_number = cljs.core.nth.call(null,vec__64417,(1),null);
var frame_pairs = cljs.core.partition.call(null,(2),af_start_end);
var vec__64420 = cljs.core.nth.call(null,frame_pairs,(frame_number - (1)));
var start = cljs.core.nth.call(null,vec__64420,(0),null);
var end = cljs.core.nth.call(null,vec__64420,(1),null);
...
var map__64423 = cljs.core.get.call(null,match,new cljs.core.Keyword(null,"timing","timing",-1849225195));
...
var event_time = cljs.core.get.call(null,map__64423__$1,new cljs.core.Keyword("re-frame","event-time","re-frame/event-time",-1349372188));
var event_handler_time = cljs.core.get.call(null,map__64423__$1,new cljs.core.Keyword("re-frame","event-handler-time","re-frame/event-handler-time",1278050644));
var event_dofx_time = cljs.core.get.call(null,map__64423__$1,new cljs.core.Keyword("re-frame","event-dofx-time","re-frame/event-dofx-time",650880716));
var event_run_time = cljs.core.get.call(null,map__64423__$1,new cljs.core.Keyword("re-frame","event-run-time","re-frame/event-run-time",1941554897));
...
return !(cljs.core.empty_QMARK_.call(null,p1__64425_SHARP_));
})], null),null);
...
cljs.spec.alpha.def_impl.call(null,new cljs.core.Keyword("subs","view-subs","subs/view-subs",253084832),cljs.core.list(new cljs.core.Symbol("cljs.spec.alpha","coll-of","cljs.spec.alpha/coll-of",1019430407,null),new cljs.core.Keyword("subs","view-panel-sub","subs/view-panel-sub",-1872730057)),cljs.spec.alpha.every_impl.call(null,new cljs.core.Keyword("subs","view-panel-sub","subs/view-panel-sub",-1872730057),new cljs.core.Keyword("subs","view-panel-sub","subs/view-panel-sub",-1872730057),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword("cljs.spec.alpha","kind-form","cljs.spec.alpha/kind-form",-1047104697),null,new cljs.core.Keyword("cljs.spec.alpha","cpred","cljs.spec.alpha/cpred",-693471218),(function (G__64428){
return cljs.core.coll_QMARK_.call(null,G__64428);
...
var G__64431 = (exp - (1));
var G__64432 = (total + (day8.re_frame_10x.subs.sub_type_value.call(null,sub_type) * Math.pow((10),exp)));
var G__64433 = cljs.core.rest.call(null,order__$1);
exp = G__64431;
total = G__64432;
order__$1 = G__64433;
continue;
...
var G__64434 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(t);
 ...
 */
day8.re_frame_10x.subs.prepare_pod_info = (function day8$re_frame_10x$subs$prepare_pod_info(p__64436,p__64437){
var vec__64438 = p__64436;
var sub_info = cljs.core.nth.call(null,vec__64438,(0),null);
var sub_state = cljs.core.nth.call(null,vec__64438,(1),null);
var vec__64441 = p__64437;
var subscription = cljs.core.nth.call(null,vec__64441,(0),null);
var remove_fn = ((cljs.core._EQ_.call(null,subscription,new cljs.core.Keyword("subs","inter-epoch-subs","subs/inter-epoch-subs",-83233716)))?((function (vec__64438,sub_info,sub_state,vec__64441,subscription){
return (function (me){
return (new cljs.core.Keyword(null,"order","order",-1254677256).cljs$core$IFn$_invoke$arity$1(cljs.core.val.call(null,me)) == null);
});})(vec__64438,sub_info,sub_state,vec__64441,subscription))
:cljs.core.constantly.call(null,false));
var subx = cljs.core.sort_by.call(null,new cljs.core.Keyword(null,"order","order",-1254677256),day8.re_frame_10x.subs.sub_sort_val,cljs.core.map.call(null,((function (remove_fn,vec__64438,sub_info,sub_state,vec__64441,subscription){
return (function (me){
...
return sub__$2;
});})(remove_fn,vec__64438,sub_info,sub_state,vec__64441,subscription))
...
mranderson047.re_frame.v0v10v2.re_frame.core.reg_sub.call(null,new cljs.core.Keyword("subs","inter-epoch-subs","subs/inter-epoch-subs",-83233716),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("subs","subscription-info","subs/subscription-info",-1799592687)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("subs","pre-epoch-state","subs/pre-epoch-state",836844033)], null),day8.re_frame_10x.subs.prepare_pod_info);
...
mranderson047.re_frame.v0v10v2.re_frame.core.reg_sub.call(null,new cljs.core.Keyword("subs","visible-subs","subs/visible-subs",-1536647862),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("subs","all-subs","subs/all-subs",1599770325)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("subs","ignore-unchanged-l2-subs?","subs/ignore-unchanged-l2-subs?",-1438622704)], null),(function (p__64444){
var vec__64445 = p__64444;
var all_subs = cljs.core.nth.call(null,vec__64445,(0),null);
var ignore_unchanged_l2_QMARK_ = cljs.core.nth.call(null,vec__64445,(1),null);
