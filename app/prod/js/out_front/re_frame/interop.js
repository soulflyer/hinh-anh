...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__13395 = cljs.core.instance_QMARK_;
var expr__13396 = reactive_val;
if(cljs.core.truth_(pred__13395.call(null,reagent.ratom.RAtom,expr__13396))){
return "ra";
} else {
if(cljs.core.truth_(pred__13395.call(null,reagent.ratom.RCursor,expr__13396))){
return "rc";
} else {
if(cljs.core.truth_(pred__13395.call(null,reagent.ratom.Reaction,expr__13396))){
return "rx";
} else {
if(cljs.core.truth_(pred__13395.call(null,reagent.ratom.Track,expr__13396))){
return "tr";
} else {
return "other";
}
