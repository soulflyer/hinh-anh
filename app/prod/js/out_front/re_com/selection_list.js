...
var args18972 = [];
var len__8057__auto___18975 = arguments.length;
var i__8058__auto___18976 = (0);
while(true){
if((i__8058__auto___18976 < len__8057__auto___18975)){
args18972.push((arguments[i__8058__auto___18976]));

var G__18977 = (i__8058__auto___18976 + (1));
i__8058__auto___18976 = G__18977;
continue;
} else {
}
break;
...
var base_style__$1 = (cljs.core.truth_((function (){var and__6936__auto__ = selected_QMARK_;
...
var base_style__$2 = (cljs.core.truth_((function (){var and__6936__auto__ = selected_QMARK_;
if(cljs.core.truth_(and__6936__auto__)){
...
if(cljs.core.truth_((function (){var and__6936__auto__ = required_QMARK_;
if(cljs.core.truth_(and__6936__auto__)){
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__18982){
var map__18985 = p__18982;
...
var args = map__18985__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__18985__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__18985__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var item_renderer = cljs.core.get.call(null,map__18985__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__18985__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__18985__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__18985__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__18985__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var hide_border_QMARK_ = cljs.core.get.call(null,map__18985__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var choices = cljs.core.get.call(null,map__18985__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__18985__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__18985__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__18985,map__18985__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__18979_SHARP_){
return item_renderer.call(null,p1__18979_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__18985,map__18985__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__18985,map__18985__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__18980_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__18980_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__18985,map__18985__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__18985,map__18985__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__18981_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__18981_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__18985,map__18985__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__8057__auto___18994 = arguments.length;
var i__8058__auto___18995 = (0);
while(true){
if((i__8058__auto___18995 < len__8057__auto___18994)){
args__8064__auto__.push((arguments[i__8058__auto___18995]));

var G__18996 = (i__8058__auto___18995 + (1));
i__8058__auto___18995 = G__18996;
continue;
} else {
}
break;
...
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(argseq__8065__auto__);
});

re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__18988){
...
var args = map__18989__$1;

return ((function (map__18989,map__18989__$1,args){
return (function() { 
var G__18997__delegate = function (p__18991){
...
while (G__18998__i < G__18998__a.length) {G__18998__a[G__18998__i] = arguments[G__18998__i + 0]; ++G__18998__i;}
  p__18991 = new cljs.core.IndexedSeq(G__18998__a,0);
} 
return G__18997__delegate.call(this,p__18991);};
G__18997.cljs$lang$maxFixedArity = 0;
G__18997.cljs$lang$applyTo = (function (arglist__18999){
var p__18991 = cljs.core.seq(arglist__18999);
return G__18997__delegate(p__18991);
});
G__18997.cljs$core$IFn$_invoke$arity$variadic = G__18997__delegate;
return G__18997;
})()
;
;})(map__18989,map__18989__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq18987){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq18987));
});
