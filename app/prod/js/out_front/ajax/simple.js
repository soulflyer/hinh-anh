...
args20768.push((arguments[i__8058__auto___20772]));
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args20768.length)].join('')));
...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__20775){
var map__20778 = p__20775;
var map__20778__$1 = ((((!((map__20778 == null)))?((((map__20778.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20778.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20778):map__20778);
var handler = cljs.core.get.call(null,map__20778__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__6948__auto__ = p1__20780_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__20781){
...
var request = map__20784__$1;
var interceptors = cljs.core.get.call(null,map__20784__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
