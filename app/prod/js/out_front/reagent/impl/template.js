...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__7559__auto__,writer__7560__auto__,opt__7561__auto__){
return cljs.core._write.call(null,writer__7560__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__13032 = o;
(G__13032[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__13033__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__13033 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__13034__i = 0, G__13034__a = new Array(arguments.length -  0);
while (G__13034__i < G__13034__a.length) {G__13034__a[G__13034__i] = arguments[G__13034__i + 0]; ++G__13034__i;}
  args = new cljs.core.IndexedSeq(G__13034__a,0);
} 
return G__13033__delegate.call(this,args);};
G__13033.cljs$lang$maxFixedArity = 0;
G__13033.cljs$lang$applyTo = (function (arglist__13035){
var args = cljs.core.seq(arglist__13035);
return G__13033__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__6936__auto__ = !((jsprops == null));
if(and__6936__auto__){
var and__6936__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__13040 = jsprops;
(G__13040["defaultValue"] = value);

(G__13040["onChange"] = ((function (G__13040,v,value,on_change){
return (function (p1__13038_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__13038_SHARP_);
});})(G__13040,v,value,on_change))
);
...
var vec__13047 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__13047,(0),null);
var id = cljs.core.nth.call(null,vec__13047,(1),null);
var class$ = cljs.core.nth.call(null,vec__13047,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___13052 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___13052 == null)){
} else {
var key_13053 = temp__4661__auto___13052;
(jsprops["key"] = key_13053);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__13055 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__13055["name"] = c);
...
var len__8057__auto___13060 = arguments.length;
var i__8058__auto___13061 = (0);
while(true){
if((i__8058__auto___13061 < len__8057__auto___13060)){
args__8064__auto__.push((arguments[i__8058__auto___13061]));

var G__13062 = (i__8058__auto___13061 + (1));
i__8058__auto___13061 = G__13062;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__8065__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq13058){
var G__13059 = cljs.core.first.call(null,seq13058);
var seq13058__$1 = cljs.core.next.call(null,seq13058);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__13059,seq13058__$1);
});
...
break;
default:
var G__13066 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__13066;
continue;
...
var n__7871__auto___13069 = a.length;
var i_13070 = (0);
while(true){
if((i_13070 < n__7871__auto___13069)){
(a[i_13070] = reagent.impl.template.as_element.call(null,(a[i_13070])));
...
var a = cljs.core.into_array.call(null,s);
var n__7871__auto___13072 = a.length;
var i_13073 = (0);
while(true){
if((i_13073 < n__7871__auto___13072)){
var val_13074 = (a[i_13073]);
if((cljs.core.vector_QMARK_.call(null,val_13074)) && ((reagent.impl.template.key_from_vec.call(null,val_13074) == null))){
(o["no-key"] = true);
} else {
}

(a[i_13073] = reagent.impl.template.as_element.call(null,val_13074));
...
var ctx = ({});
var vec__13079 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__13079,(0),null);
var derefed = cljs.core.nth.call(null,vec__13079,(1),null);
...
var G__13083 = (cljs.core.count.call(null,argv) - first_child);
switch (G__13083) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__13083){
