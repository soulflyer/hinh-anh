(defproject anh "0.1.0-SNAPSHOT"
  ...
  :aliases {"descjop-help" ["new" "descjop" "help"]
            ...
            "descjop-uberapp-osx" ["shell" "electron-packager" "./app/prod" "anh" "--platform=darwin" "--arch=x64" "--electron-version=1.6.6"]
            "descjop-uberapp-app-store" ["shell" "electron-packager" "./app/prod" "anh" "--platform=mas" "--arch=x64" "--electron-version=1.6.6"]
            "descjop-uberapp-linux" ["shell" "electron-packager" "./app/prod" "anh" "--platform=linux" "--arch=x64" "--electron-version=1.6.6"]
            "descjop-uberapp-win64" ["shell" "cmd.exe" "/c" "electron-packager" "./app/prod" "anh" "--platform=win32" "--arch=x64" "--electron-version=1.6.6"]
            "descjop-uberapp-win32" ["shell" "cmd.exe" "/c" "electron-packager" "./app/prod" "anh" "--platform=win32" "--arch=ia32" "--electron-version=1.6.6"]
            }
